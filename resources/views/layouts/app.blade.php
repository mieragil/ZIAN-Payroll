            ...
            <div id="wrapper">
                ...
                <div id="sidebar-wrapper" class="bg-dark">
                    <ul class="sidebar-nav">
                        ...
                        <li>
                            <a href="{{route('deduction.index')}}"><i class="fas fa-comments-dollar m-3"></i>Deductions</a>
                        </li>
                        <li>
                                ...
                                <div class="col-lg-12 p-4">
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="" class="form-control" id="inputEmail4" name="phic" placeholder="amount">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label for="inputPassword4">SSS:</label>
                                                <input type="" class="form-control" id="inputPassword4" name="sss" placeholder="amount">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label for="inputEmail4">PAG-IBIG:</label>
                                                <input type="" class="form-control" id="inputEmail4" name="pag_ibig" placeholder="amount">
                                            </div>
                                            {{-- <div class="form-group col-md-6">
